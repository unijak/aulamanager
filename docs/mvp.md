...
* Visualizar missão
* Acompanhar progresso da missão
...
O gerenciamento de turmas e atividades constitui o núcleo do sistema, enquanto as Missões de Aprendizagem foram incluídas por representarem o principal diferencial do Aula Manager em relação a outras plataformas de gestão educacional. Essa funcionalidade permite organizar conteúdos e atividades em trilhas estruturadas de aprendizagem, proporcionando uma experiência mais organizada e intuitiva para estudantes e professores
